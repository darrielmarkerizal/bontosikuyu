...
export default function ArtikelBanner({
  totalArticles,
  categoryCounts,
  categories,
  recentArticles,
}: ArtikelBannerProps) {
  // Safe handling of categoryCounts with null/undefined check
  const safeCategoryCounts = categoryCounts || {};
  const categoryList = Object.entries(safeCategoryCounts);
  const topCategory =
    categoryList.length > 0
      ? categoryList.sort(([, a], [, b]) => b - a)[0]
      : null;
  ...
  return (
    <div className="relative">
      ...
      <div className="absolute inset-0">
        <Image
          src="https://images.unsplash.com/photo-1507003211169-0a1dd7228f2d?w=1200&h=600&fit=crop&auto=format"
          alt="Artikel Background - Reading and knowledge"
          fill
            ...
            <div className="text-white space-y-6">
              <div className="space-y-4">
                ...
                <p className="text-xl lg:text-2xl text-white/90 font-plus-jakarta-sans leading-relaxed max-w-2xl">
                  Ikuti perkembangan terkini dan berbagai informasi penting dari
                  Desa Laiyolo Baru, Kepulauan Selayar.
                </p>
              </div>
                  ...
                  <div className="space-y-4">
                    ...
                    {categoryList.length > 0 ? (
                            ...
                            <div className="flex items-center gap-2">
                              <div className="h-2 w-16 bg-gray-200 rounded-full overflow-hidden">
                                <div
                                  ...
                                  style={{
                                    width: `${(count / Math.max(...categoryList.map(([, c]) => c))) * 100}%`,
                                  }}
                                ></div>
                              </div>
                      ...
                      <div className="text-center py-4">
                        <p className="text-gray-500 font-plus-jakarta-sans text-sm">
                    ...
                    {topCategory && (
                      <div className="mt-4 p-3 bg-brand-primary/5 rounded-lg border border-brand-primary/10">
                        <p className="text-sm text-brand-secondary font-plus-jakarta-sans">
                          ...
                          memiliki artikel terbanyak dengan{" "}
                          <span className="font-semibold text-brand-primary">
                            {topCategory[1]} artikel
                          </span>
                        </p>
                      </div>
                    )}
